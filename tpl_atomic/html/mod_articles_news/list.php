 ...
 *
 * Atomic List — renders the Articles - Newsflash module (Joomla 4) as a
...
?>
<div class="mod-articlesnews newsflash atomic-articles-list-module">
    <ul class="atomic-articles-list list-unstyled">
        <?php foreach ($items as $item) : ?>
            <?php
            // Newsflash items are close to raw article rows — guard every
            // property so an entry with missing data degrades cleanly.
            ...
            <li class="atomic-articles-list-item d-flex gap-3 align-items-center">
                ...
                <div class="atomic-articles-list-body">
                    ...
                    <?php endif; ?>
                    <?php if ($date !== '') : ?>
                        <small class="atomic-articles-list-date d-block"><?php echo HTMLHelper::_('date', $date, Text::_('DATE_FORMAT_LC3')); ?></small>
                    <?php endif; ?>
                </div>
            </li>
        <?php endforeach; ?>
